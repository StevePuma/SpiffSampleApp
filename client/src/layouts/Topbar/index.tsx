...
import SisenseUrlLink from '../../components/topbar/SisenseUrlLink';

// dummy data
import { notifications, profileMenus, searchOptions } from './data';

// images
import logoSm from '../../assets/images/crm_favicon.png';
            ...
            <div className={containerClass}>
                <ul className="list-unstyled topnav-menu float-end mb-0">
                    <li className="d-lg-block">
                        {loggedInUser.email.includes('@sisense.com') &&
                            <SisenseUrlLink />
                        }
                    </li>
                    ...
                    <li className="dropdown notification-list topbar-dropdown">
                        {/* User */}
                        <ProfileDropdown userImage={avatar} username={loggedInUser.firstName} menuItems={profileMenus} />
                    </li>
                ...
                <div className="logo-box">
                    <Link to="/" className="logo logo-dark text-center">
                        <span className="logo-sm">
                            <img src={logoSm} alt="logo-sm" height="50" />
                        </span>
                        <span className="logo-lg">
                            <img src={logoDark} alt="logo-dark" height="75" />
                        </span>
                    </Link>
                    ...
                    <Link to="/" className="logo logo-light text-center">
                        ...
                        <span className="logo-lg">
                            <img src={logoLight} alt="logo-light" height="75" />
                        </span>
                    </Link>
                </div>
