...
//TODO: Add something to call /api/v1/dashboards and render menu items for each dashboard
// will need to be AFTER authentication somehow, and render the same structure as MENU_ITEMS
