        ...
        <Dropdown show={isOpen} onToggle={toggleDropdown}>
            ...
            <Dropdown.Menu align="end" className="profile-dropdown">
                <div onClick={toggleDropdown}>
                    <Dropdown.Header className="noti-title-no-v-padding">
                        <span className="text-overflow m-0 font-11">App Version: {config.VERSION}</span>
                        <br/>
                        <span className="text-overflow m-0 font-11">Deployed: {config.DEPLOY_DATE}</span>
