...
import { w as wait, d as debounce } from './utils.js';
import { c as contextRegistry } from './contextRegistry.js';

const SisenseWidget$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["sisense-widget"];
  components.forEach(tagName => { switch (tagName) {
    case "sisense-widget":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, SisenseWidget$1);
      }
      break;
  } });
}

const SisenseWidget = SisenseWidget$1;
const defineCustomElement = defineCustomElement$1;

export { SisenseWidget, defineCustomElement };
